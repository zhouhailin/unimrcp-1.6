...
MRCP_PLUGIN_DECLARE(mrcp_engine_t*) mrcp_plugin_create(apr_pool_t *pool)
{
	...
	apt_task_msg_pool_t *msg_pool;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog plugin create ...");
...
static apt_bool_t xfyun_recog_engine_destroy(mrcp_engine_t *engine)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine destroy.");
...
static apt_bool_t xfyun_recog_engine_open(mrcp_engine_t *engine)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine open.");
	
	const mrcp_engine_config_t *config = mrcp_engine_config_get(engine);
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine open ######## max_channel_count : %d", config->max_channel_count);
        const char *accessKeyId = apr_table_get(config->params, "accessKeyId");
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine open ######## accessKeyId       : %s", accessKeyId);
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine open ######## accessKeySecret   : %s", apr_table_get(config->params, "accessKeySecret"));
...
static apt_bool_t xfyun_recog_engine_close(mrcp_engine_t *engine)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine close.");
...
static mrcp_engine_channel_t* xfyun_recog_engine_channel_create(mrcp_engine_t *engine, apr_pool_t *pool)
{
	...
	mpf_termination_t *termination; 
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog engine channel create.");
...
static apt_bool_t xfyun_recog_channel_destroy(mrcp_engine_channel_t *channel)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel destroy.");
	/* nothing to destrtoy */
	return TRUE;
}
...
static apt_bool_t xfyun_recog_channel_open(mrcp_engine_channel_t *channel)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel open ...");
...
static apt_bool_t xfyun_recog_channel_close(mrcp_engine_channel_t *channel)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel close.");
...
static apt_bool_t xfyun_recog_channel_request_process(mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel request process.");
...
static apt_bool_t xfyun_recog_channel_recognize(mrcp_engine_channel_t *channel, mrcp_message_t *request, mrcp_message_t *response)
{
	...
	mrcp_recog_header_t *recog_header;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel recognize ...");
...
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel stop.");
...
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel timers start.");
...
static apt_bool_t xfyun_recog_channel_request_dispatch(mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_bool_t processed = FALSE;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog channel request dispatch.");
...
static apt_bool_t xfyun_recog_stream_destroy(mpf_audio_stream_t *stream)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog stream destroy.");
	return TRUE;
}
...
static apt_bool_t xfyun_recog_stream_open(mpf_audio_stream_t *stream, mpf_codec_t *codec)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog stream open ...");
	return TRUE;
}
...
static apt_bool_t xfyun_recog_stream_close(mpf_audio_stream_t *stream)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog stream close.");
	return TRUE;
}
...
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog start of input.");
...
static apt_bool_t xfyun_recog_result_load(xfyun_recog_channel_t *recog_channel, mrcp_message_t *message)
{
	FILE *file;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog result load.");
	...
	/* read the xfyun result from file */
...
static apt_bool_t xfyun_recog_recognition_complete(xfyun_recog_channel_t *recog_channel, mrcp_recog_completion_cause_e cause)
{
	mrcp_recog_header_t *recog_header;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog recognition complete.");
...
static apt_bool_t xfyun_recog_stream_write(mpf_audio_stream_t *stream, const mpf_frame_t *frame)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog stream write.");
...
static apt_bool_t xfyun_recog_msg_signal(xfyun_recog_msg_type_e type, mrcp_engine_channel_t *channel, mrcp_message_t *request)
{
	apt_bool_t status = FALSE;
        ...
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog msg signal.");
...
static apt_bool_t xfyun_recog_msg_process(apt_task_t *task, apt_task_msg_t *msg)
{
        apt_log(RECOG_LOG_MARK,APT_PRIO_INFO,"# Xfyun recog msg process.");
